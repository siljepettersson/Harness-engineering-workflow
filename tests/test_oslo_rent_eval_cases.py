...
class OsloRentEvalCasesTests(unittest.TestCase):
    @classmethod
    ...
    def test_each_case_has_required_fields(self) -> None:
        ...
        for case in self.cases:
            ...
            self.assertEqual(case["topic"], "oslo-rent")
    ...
    def test_expected_sources_exist_in_raw_source_directory(self) -> None:
        available_sources = {path.name for path in self.raw_source_dir.glob("*.md")}
